            ...
            <Row id="projectSummary">
              <ListGroup variant="flush" style={{ padding: 0 }}>
                <ListGroup.Item>
                  ...
                  HTML, CSS, JavaScript, SQLite를 이용해 설문조사 페이지 만들기
                  </p>
                </ListGroup.Item>
                <ListGroup.Item>
                  <p>
                ...
                <ListGroup.Item>
                  <p>
                    <b>주요기능</b> : 설문조사 페이지, 중복허용, 설문조사 값 저장 및 표기
                  </p>
                </ListGroup.Item>
                <ListGroup.Item>
                  <p>HTML, CSS, JavaScript, SQLite</p>
                </ListGroup.Item>
                <ListGroup.Item>
                  <p id="linkText">
                    <a
                ...
                <ListGroup.Item>
                  ...
                  <p>
                  CRUD에 관심이 생기면서 가벼운 주제부터 해보자고 생각했습니다. 수업을 토대로 JavaScript에 대해서 더 공부하면서 추가적으로 <b>저장하고 읽고 수정하고 삭제까지 하는 과정을 이해</b>하고, <b>SQL</b>을 이용해서 이를 원활하게 사용하고자 하는 것을 배우고자 했습니다.
                  </p>
                </ListGroup.Item>
                <ListGroup.Item>
                  <p className="my-2" id="meaningText">
                  ...
                  <p>
                  한 학기에 SQL문을 가까이서 배우고 이해하면서 어떤 흐름인지를 조금이나마 깨닫게 되었습니다. Table을 만들고 그에 따른 데이터를 선별하고 선택하면서 쉬워보이지만 잘못하면 다른 정보들도 가져오거나, 필요한 정보를 빼놓고 올 수도 있다는 생각을 하게 되었습니다. 데이터베이스 뿐만 아니라 프론트 혹은 백에서 요청하는 값이 실수가 나면 전혀 전달이 이루어지지 않듯이 <b>정확하게 이해하고 사용해야 오류 없이 이뤄지는 것</b>을 더욱 몸소 느끼게 되었습니다. 그렇기에 더욱 많은 지식이 필요함을 크게 배우는 시간이었습니다.
                  </p>
                </ListGroup.Item>
              </ListGroup>
            </Row>
