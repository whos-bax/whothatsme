        ...
        <Row id="projectBody">
          ...
          <Col md={6}>
            ...
            <Row id="projectDropdown">
              <Dropdown drop="up">
                <Dropdown.Toggle variant="success">배경</Dropdown.Toggle>

                <Dropdown.Menu style={{ border: "3px #171717 solid" }}>
                  <Dropdown.ItemText>
                    <p>
                    JavaScript에 대한 공부 없이 React로 시작한 입장에서 <b>기본을 더 공부해야겠다</b> 하는 생각이 들었습니다. 여름 프로젝트의 팀장의 조언으로 JavaScript를 더 공부해보자는 생각으로 시작했습니다.
                    </p>
                  </Dropdown.ItemText>
                </Dropdown.Menu>
              </Dropdown>
              ...
              <Dropdown drop="down">
                <Dropdown.Toggle variant="warning">의의</Dropdown.Toggle>

                <Dropdown.Menu style={{ border: "3px #171717 solid" }}>
                  <Dropdown.ItemText>
                    <p>
                    HTML과 Vanilla JS, CSS만을 이용해서 만들어보면서 <b>왜 React를 사용하고 Bootstrap을 사용하려 하는지에 대한 이유</b>를 이해할 수 있었습니다. React는 컴포넌트를 나누어서 사용해서 각 부분 별로 작업이 가능하기에 이 프로젝트와 비교하여 장점을 극명히 느낄 수 있었습니다. 기본이 되는 자바스크립트를 더 알고 이해하는 시간을 가질 수 있었습니다.
                    </p>
                  </Dropdown.ItemText>
                </Dropdown.Menu>
              </Dropdown>
