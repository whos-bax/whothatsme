          ...
          <Col md={6}>
            <Row id="projectSummary">
              <ListGroup variant="flush" style={{ padding: 0 }}>
                ...
                <ListGroup.Item>
                  <p>
                    <b>주요기능</b> : 반응형 UI, React-Router-dom 을 이용한 페이지 이동,
                    Emailjs를 이용한 이메일 전송, 방명록을 이용한 CRUD 기능
                  </p>
                </ListGroup.Item>
                <ListGroup.Item>
                  <p>
                ...
                <ListGroup.Item>
                  ...
                  <p>
                    이전에 했던 프로젝트에서는 결국 내가 제대로 할 수 있었던 것은 너무나도 작은 범위였구나 하는 생각을 했습니다. <b>Client-Server-DB 의 연동</b>을 이해하면서 직접 기능이 될 수 있기까지 짧은 기간이지만 많은 시간이 소요되었습니다. 우선적으로 리액트의 대한 이해를 높히는 시간을 갖을 수 있었으며, <b>Hook을 이용해 상태변화에 따른 페이지의 변동</b>이라는 점을 배우게 되었습니다. 또 <b>React-Router-Dom을 이용해서 페이지가 재로드 되지 않고, 컴포넌트의 값을 변화</b>하도록 하는 구현을 하면서 개발자와 사용자 둘의 입장에서 바라볼 수 있게 되었습니다. 또,<b>CRUD 기능을 구현</b>하는 과정에서는 클라이언트와 서버, 데이터베이스가 상호적으로 데이터를 주고 받도록 하면서 원하고자 하는 바가 성공할 떄는 굉장히 기뻤습니다. 가장 힘들었던 부분은 서버에 대한 이해도가 전혀 없어서 시작하는 부분부터 어려웠는데, 처음부터 천천히 진행하면서 구조가 어떻게 되어있는지를 생각하다보니 생각보다 쉽게 마무리 되었습니다.
                  </p>
                </ListGroup.Item>
              </ListGroup>
            </Row>
