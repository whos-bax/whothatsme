            ...
            <li>
              ...
              {first && (
                <div className="detailStyle">
                  ...
                  <p>
                    → 음원플랫폼 뿐만 아니라 사운드클라우드를 통해 무료곡 공개
                  </p>
            ...
            <li>
              ...
              {second && (
                <div className="detailStyle">
                  ...
                  <p>
                    → <b>영상 촬영 및 편집, 출연</b> 등 매주 팀원들과 모여
                    컨텐츠 회의를 진행하고 촬영 및 편집 관련 인원을 분배하여
                    진행
                  </p>
                  <p>
                    → 창업정석검사, 창업교육센터소개, 교육청
            ...
            <li>
              ...
              {fourth && (
                <div className="detailStyle">
                  ...
                  <p>
                    → 청소년들의 앞날과 더 좋은 세상을 위해서 조금이나마 기부
                    시작
                  </p>
                  <Image
                    src={
